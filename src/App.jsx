...
const tousLesQuiz = {
  debutant: [
    { q: "Combien de temps un recruteur passe-t-il en moyenne sur un CV ?", options: ["30 secondes", "10 secondes", "2 minutes", "5 minutes"], correct: 1, explication: "Les recruteurs passent en moyenne 10 secondes sur un CV avant de décider de continuer ou pas. La lisibilité et la clarté sont donc primordiales." },
  ...
  intermediaire: [
    ...
    { q: "Comment répondre à la question 'Quels sont vos axes d'amélioration professionnels ?'", options: ["Indiquer que l'on est en constante progression sans identifier d'axe précis", "Identifier 2 à 3 axes concrets et expliquer les actions mises en place pour progresser", "Préciser que l'on n'a pas d'axes d'amélioration significatifs à ce stade", "Exprimer une difficulté à répondre à cette question"], correct: 1, explication: "Identifier des axes d'amélioration réels et expliquer les actions concrètes mises en place montre votre maturité professionnelle et votre capacité à vous remettre en question. C'est un signal fort de sérieux pour un recruteur." },
  ...
  avance: [
    ...
    { q: "Pourquoi est-il important d'intégrer des mots-clés spécifiques au poste dans ton CV ?", options: ["Pour impressionner le recruteur avec du vocabulaire technique", "Pour que ton CV soit en adéquation avec les termes utilisés dans l'offre et les attentes du poste", "Pour allonger ton CV et le rendre plus complet", "Les mots-clés ne sont pas importants sur un CV"], correct: 1, explication: "Reprendre les termes exacts de l'offre d'emploi dans ton CV montre que tu as bien lu et compris le poste. Cela facilite aussi la lecture du recruteur qui retrouve immédiatement les compétences qu'il recherche." },
